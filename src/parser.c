...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 303:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(303);
      if (sym_number_literal_character_set_1(lookahead)) ADVANCE(319);
      END_STATE();
    case 304:
      ACCEPT_TOKEN(sym_number_literal);
      ...
      if (('D' <= lookahead && lookahead <= 'F') ||
          ('d' <= lookahead && lookahead <= 'f')) ADVANCE(314);
      if (lookahead == 'L' ||
          lookahead == 'U' ||
          lookahead == 'W' ||
          lookahead == 'l' ||
    ...
    case 305:
      ...
      if (('B' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(314);
      if (lookahead == 'L' ||
          lookahead == 'U' ||
          lookahead == 'W' ||
          lookahead == 'l' ||
    ...
    case 310:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          ('a' <= lookahead && lookahead <= 'c')) ADVANCE(311);
      END_STATE();
    case 311:
      ACCEPT_TOKEN(sym_number_literal);
      if (lookahead == '\'') ADVANCE(219);
    ...
    case 315:
      ...
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(308);
      if (sym_number_literal_character_set_2(lookahead)) ADVANCE(319);
      END_STATE();
    case 316:
      ACCEPT_TOKEN(sym_number_literal);
      if (lookahead == '+' ||
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_sections] = STATE(213),
    [sym_prologue] = STATE(156),
    [sym_grammar_rules_section] = STATE(211),
    [sym_declaration] = STATE(114),
    [sym__decl_type] = STATE(112),
    [sym__decl_require] = STATE(112),
    [sym__decl_token] = STATE(112),
    [sym__decl_nterm] = STATE(112),
    [sym__decl_op_precedence] = STATE(112),
    [sym__decl_initial_declaration] = STATE(112),
    [sym__decl_glr_parser] = STATE(112),
    [sym__decl_destructor] = STATE(112),
    [sym__decl_printer] = STATE(112),
    [sym__decl_expect] = STATE(112),
    [sym__decl_start] = STATE(112),
    [sym__decl_define] = STATE(112),
    [sym__decl_code] = STATE(112),
    [sym__decl_union] = STATE(112),
    [sym__decl_debug] = STATE(112),
    [sym__decl_header] = STATE(112),
    [sym__decl_locations] = STATE(112),
    [sym__decl_name_prefix] = STATE(112),
    [sym__decl_no_lines] = STATE(112),
    [sym__decl_output] = STATE(112),
    [sym__decl_pure_parser] = STATE(112),
    [sym__decl_skeleton] = STATE(112),
    [sym__decl_token_table] = STATE(112),
    [sym__decl_verbose] = STATE(112),
    [sym__decl_yacc] = STATE(112),
    [sym__decl_inial_action] = STATE(112),
    [sym__decl_parse_param] = STATE(112),
    [sym_comment] = STATE(1),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(152)] = 4033,
  [SMALL_STATE(153)] = 4050,
  [SMALL_STATE(154)] = 4069,
  [SMALL_STATE(155)] = 4088,
  [SMALL_STATE(156)] = 4107,
  ...
  [SMALL_STATE(187)] = 4612,
  [SMALL_STATE(188)] = 4625,
  [SMALL_STATE(189)] = 4638,
  ...
  [SMALL_STATE(201)] = 4794,
  [SMALL_STATE(202)] = 4807,
  [SMALL_STATE(203)] = 4820,
  [SMALL_STATE(204)] = 4833,
  [SMALL_STATE(205)] = 4846,
  [SMALL_STATE(206)] = 4859,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_rules_body_repeat1, 2), SHIFT_REPEAT(13),
  ...
  [27] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sections_repeat1, 2), SHIFT_REPEAT(145),
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat2, 2),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat1, 2),
  [107] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_grammar_rule_repeat1, 2), SHIFT_REPEAT(13),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat1, 2), SHIFT_REPEAT(192),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat1, 2), SHIFT_REPEAT(203),
  [116] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat1, 2), SHIFT_REPEAT(166),
  [119] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat1, 2), SHIFT_REPEAT(198),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(178),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_type, 4),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_type, 4),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(172),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rule_identifier, 1),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_rule_identifier, 1),
  [134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(174),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_type, 3),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_type, 3),
  ...
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rule_identifier, 3),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_rule_identifier, 3),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 3),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_type_repeat1, 2),
  [156] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__decl_type_repeat1, 2), SHIFT_REPEAT(13),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_type_repeat1, 2),
  [161] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_type_repeat1, 2), SHIFT_REPEAT(166),
  [164] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_type_repeat1, 2), SHIFT_REPEAT(198),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_type_repeat2, 2),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_type_repeat2, 2),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat1, 1),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_token_repeat1, 1),
  ...
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_char_quoted, 3),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_char_quoted, 3),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_define, 4),
  [187] = {.entry = {.count = 1, .reusable = false}}, SHIFT(113),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_define, 4),
  [191] = {.entry = {.count = 1, .reusable = true}}, SHIFT(208),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat1, 2),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_token_repeat1, 2),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_define, 3),
  [201] = {.entry = {.count = 1, .reusable = false}}, SHIFT(133),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_define, 3),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_define_repeat1, 2),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_define_repeat1, 2),
  [211] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_define_repeat1, 2), SHIFT_REPEAT(208),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat2, 1),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_token_repeat2, 1),
  ...
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_type_repeat1, 1),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_type_repeat1, 1),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat2, 2),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_token_repeat2, 2),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 1),
  [234] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_action, 1),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component, 1),
  [238] = {.entry = {.count = 1, .reusable = true}}, SHIFT(204),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component, 1),
  [242] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat1, 1),
  [246] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_grammar_rule_repeat1, 1),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_op_precedence, 4),
  [250] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [252] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_op_precedence, 4),
  [254] = {.entry = {.count = 1, .reusable = true}}, SHIFT(180),
  [256] = {.entry = {.count = 1, .reusable = true}}, SHIFT(210),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_op_precedence, 3),
  [260] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_op_precedence, 3),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive_merge, 4),
  [264] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive_merge, 4),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component, 4),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component, 4),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_header, 2),
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_header, 2),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_nterm, 4),
  [276] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_nterm, 4),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_op_precedence_repeat2, 2),
  [282] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_op_precedence_repeat2, 2),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_nterm, 3),
  [286] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_nterm, 3),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_token, 4),
  [290] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_token, 4),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_token, 3),
  [296] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_token, 3),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_nterm_repeat1, 2),
  [300] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_nterm_repeat1, 2), SHIFT_REPEAT(53),
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_nterm_repeat1, 2),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_op_precedence_repeat1, 2),
  [307] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_op_precedence_repeat1, 2), SHIFT_REPEAT(55),
  [310] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_op_precedence_repeat1, 2),
  [312] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_op_precedence_repeat1, 2), SHIFT_REPEAT(210),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_nterm_repeat1, 1),
  [317] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_nterm_repeat1, 1),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_destructor, 3),
  ...
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_op_precedence_repeat1, 1),
  [329] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_op_precedence_repeat1, 1),
  ...
  [341] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_destructor_repeat1, 2),
  [343] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_destructor_repeat1, 2), SHIFT_REPEAT(90),
  [346] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_destructor_repeat1, 2),
  [348] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_destructor_repeat1, 2), SHIFT_REPEAT(130),
  [351] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_printer, 4),
  [353] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_printer, 4),
  [355] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat1, 2), SHIFT_REPEAT(21),
  [358] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type_tag, 3),
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_tag, 3),
  [362] = {.entry = {.count = 1, .reusable = false}}, SHIFT(188),
  [364] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat2, 2), SHIFT_REPEAT(27),
  [367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_nterm_repeat2, 1),
  [369] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_nterm_repeat2, 1),
  [371] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_type, 5),
  [373] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_type, 5),
  [375] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_op_precedence_repeat2, 2), SHIFT_REPEAT(180),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_op_precedence, 5),
  [380] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_op_precedence, 5),
  [382] = {.entry = {.count = 1, .reusable = false}}, SHIFT(202),
  [384] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_nterm_repeat2, 2),
  [386] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_nterm_repeat2, 2),
  [388] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_nterm_repeat2, 2), SHIFT_REPEAT(180),
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_nterm, 5),
  [393] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_nterm, 5),
  [395] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_type_repeat2, 2), SHIFT_REPEAT(172),
  [398] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat3, 2),
  [400] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_token_repeat3, 2),
  [402] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat3, 2), SHIFT_REPEAT(180),
  [405] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [407] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_token, 5),
  [409] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_token, 5),
  [411] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [413] = {.entry = {.count = 1, .reusable = true}}, SHIFT(199),
  [415] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_destructor_repeat1, 3),
  [417] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_destructor_repeat1, 3),
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_destructor_repeat1, 1),
  [421] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_destructor_repeat1, 1),
  [423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 1),
  [425] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 1),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat1, 3),
  [429] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_token_repeat1, 3),
  [431] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_token_repeat2, 3),
  [433] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__decl_token_repeat2, 3),
  [435] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [437] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3),
  [439] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_require, 3),
  [441] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_require, 3),
  [443] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_define, 6),
  [445] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_define, 6),
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_debug, 2),
  [449] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_debug, 2),
  [451] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_grammar_rules_body_repeat1, 2),
  [453] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_code, 5),
  [455] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_code, 5),
  [457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rule, 5),
  [459] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_rule, 5),
  [461] = {.entry = {.count = 1, .reusable = true}}, SHIFT(217),
  [463] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 1),
  [465] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_define, 7),
  [467] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_define, 7),
  [469] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rule, 7),
  [471] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_rule, 7),
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 1),
  [475] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 1),
  [477] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_define, 5),
  [479] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_define, 5),
  [481] = {.entry = {.count = 1, .reusable = true}}, SHIFT(159),
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sections_repeat1, 1),
  [485] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sections_repeat1, 1),
  [487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_expect, 3),
  [489] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_expect, 3),
  [491] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rule, 6),
  [493] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_rule, 6),
  [495] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_glr_parser, 2),
  [497] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_glr_parser, 2),
  [499] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_parse_param, 3),
  [501] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_parse_param, 3),
  [503] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_yacc, 2),
  [505] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_yacc, 2),
  [507] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_inial_action, 3),
  [509] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_inial_action, 3),
  [511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_verbose, 2),
  [513] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_verbose, 2),
  [515] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_token_table, 2),
  [517] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_token_table, 2),
  [519] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_locations, 2),
  [521] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_locations, 2),
  [523] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_initial_declaration, 3),
  [525] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_initial_declaration, 3),
  [527] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_skeleton, 3),
  [529] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_skeleton, 3),
  [531] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_output, 3),
  [533] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_output, 3),
  [535] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_name_prefix, 3),
  [537] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_name_prefix, 3),
  ...
  [545] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_pure_parser, 2),
  [547] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_pure_parser, 2),
  [549] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_header, 3),
  [551] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_header, 3),
  [553] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_union, 3),
  [555] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_union, 3),
  [557] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_code, 4),
  [559] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_code, 4),
  [561] = {.entry = {.count = 1, .reusable = true}}, SHIFT(220),
  [563] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_union, 4),
  [565] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_union, 4),
  [567] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rule, 4),
  [569] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_rule, 4),
  [571] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_no_lines, 2),
  [573] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_no_lines, 2),
  [575] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_code, 3),
  [577] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_code, 3),
  [579] = {.entry = {.count = 1, .reusable = true}}, SHIFT(195),
  [581] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 2),
  [583] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__decl_start, 3),
  [585] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__decl_start, 3),
  ...
  [595] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_grammar_rules_body_repeat1, 1),
  [597] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_grammar_rules_body_repeat1, 1),
  [599] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prologue, 3),
  [601] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 3),
  [603] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_prologue_body_repeat1, 2),
  [605] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_prologue_body_repeat1, 2), SHIFT_REPEAT(177),
  [608] = {.entry = {.count = 1, .reusable = true}}, SHIFT(171),
  [610] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__decl_code_repeat1, 2),
  [612] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__decl_code_repeat1, 2), SHIFT_REPEAT(220),
  ...
  [621] = {.entry = {.count = 1, .reusable = false}}, SHIFT(18),
  [623] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prologue, 2),
  [625] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue, 2),
  [627] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2),
  [629] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(183),
  [632] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sections_repeat1, 2),
  [634] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  [636] = {.entry = {.count = 1, .reusable = true}}, SHIFT(111),
  [638] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prologue_body, 1),
  [640] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_rule_repeat2, 2), SHIFT_REPEAT(11),
  [643] = {.entry = {.count = 1, .reusable = true}}, SHIFT(142),
  [645] = {.entry = {.count = 1, .reusable = false}}, SHIFT(16),
  [647] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [649] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rules_section, 2),
  [651] = {.entry = {.count = 1, .reusable = true}}, SHIFT(197),
  [653] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_prologue_body_repeat1, 1),
  [655] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 1),
  [657] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 1),
  [659] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_rules_section, 4),
  ...
  [671] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sections, 2),
  ...
  [679] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 3),
  ...
  [711] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sections, 1),
