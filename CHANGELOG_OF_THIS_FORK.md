...
- fix: allow empty alternatives (RHS may have zero components; `%empty` remains supported)
...
- chore: clarify licensing (add MIT text, package includes, per-file license map)
